...
@ 
\section{Overview}
\emph{SymbiotaR2} allows users to connect to and download data from
...
straightforward and easy to use. The general argument structure of \emph{SymbiotaR2} 
allows users to specify whether they want to pull a single resource or a 
collection of resources from the API.

\section{Example}
The \emph{SymbiotaR2} package includes commands to pull from the Checklists, 
