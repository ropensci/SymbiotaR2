...
# Dynamic function-no items within development database with which to check
...
# ProjectCategories function--no items within development database with which to check
...
# TaxaComments function--no items within development database with which to check
...
# Configurations function--works. (This function has more arguments than the others in the API)
...
# Sources function--no items within development database with which to check
...
# Nlp function--no items within development database with which to check
...
# NlpFragment function--no items within development database with which to check
...
# NlpVersion function--no items within development database with which to check
...
# OcrFragment function--no items within development database with which to check
...
# CharacterHeading function--works
...
# CharacterStateImages function--works
...
# DescriptionDeletions function--works
...
Descriptions <- function(url=default.url,ID,page){
  ...
  if(!missing(ID)){
    # Build a path corresponding to the url to pull from using function arguments
    complete_url <- paste0(url,"key/descriptions/",ID)
    # Specify a random file (with the JSON extension) to write the JSON object to in the tmp directory
    sampleDestination <- tempfile()
    # Download the file from the url to the destination file
    download.file(url = complete_url, destfile = sampleDestination)
...
# LookupLanguages function--works
...
# Media function--no items within development database with which to check
...
# Keywords function--no items within development database with which to check
...
# TagKey function--works, but ID must be a string rather than a numeric; consider adding an argument check
...
# EditLocks function--no items within development database with which to check
...
# GuidDeterminations function--works, but ID must be a string rather than a numeric; consider adding an argument check
...
# GuidOccurrences function--works, but ID must be a string rather than a numeric; consider adding an argument check
...
# Identifiers function--no items within development database with which to check
...
# LookupCountries function--works
...
# LookupMunicipalities function--no items within development database with which to check
...
# LookupStateProvinces function--works
...
# Revisions function--no items within development database with which to check
...
# UploadDeterminations function--no items within development database with which to check
...
# UploadMappings function--no items within development database with which to check
...
# UploadOccurrences function--no items within development database with which to check
...
# UploadParameters function--no items within development database with which to check
...
# Genetic function--no items within development database with which to check
...
# Authors function--no items within development database with which to check
...
# ChecklistTaxaLink function--no items within development database with which to check
...
# LookupReferenceTypes function--works
...
# References function--no items within development database with which to check
...
# DescriptionBlock function--works
...
# Attributes function--works, but ID must be a string with stateId, rather than a numeric; consider adding an argument check
...
# UserRoles function--works, but permissions argument is a binary (presence/absence)--need to reflect this in argument checks
